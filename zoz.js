//if you wan to use Zozscript in html then take this code link it to your html file by using : <script src="zoz.js"></script>
//and to start writing in Zoz code then you need to create <zoz-script></zoz-script> elements and type in them your code
const TokenTypes = {
...
// SETUP: Pure Browser runtime automation layer
